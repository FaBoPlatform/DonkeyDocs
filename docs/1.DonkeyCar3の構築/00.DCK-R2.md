...
|![](./img/BOM/DCK2_BAT.jpg)|モバイルバッテリー<br>INIU BI-B3 10000mAh/37Wh 5V/3A出力<br>マイクロUSBケーブル付属|１台|
|![](./img/BOM/DCK2_JOYSTICK.jpg)|ゲームパッド<br>ワイヤレスゲームパッド F710またはF710r<br>2.4 GHZワイヤレス接続<br>入力規格：DirectInput,XInput<br>単三乾電池２本付属<br>レシーバーはUSB|１台|
|![](./img/BOM/RASPI3BP.jpg)|Raspberry　Pi3 B+|１枚|
|![](./img/BOM/DRC2_CAM.jpg)|PiCamera<br>広角 魚眼レンズ<br> 5 MP Omnivision 5647|１個|
|![](./img/BOM/DRC2_SD.jpg)|microSDカード<br>サンディスク SanDisk 64GB SDSQXCY-064G-GN6MA Extreme PRO<br>SD変換アダプター付属|１枚|
|![](./img/BOM/DCK2_CARDCASE.jpg)|SDカードケース|１個|
|![](./img/BOM/DCK2_USBCABLE.jpg)|USBケーブル<br>マイクロUSBー標準USB<br>L字|１本|
|![](./img/BOM/DONKEYB.jpg)|制御基板 <br>#608 FaBo DonkeyBoard<br>OLEDディスプレイ付き,PCA9685搭載、I2Cポート<br>Rev2.0.5|１枚|
...
|![](./img/BOM/DCK2_HENKAN.jpg)|充電用変換コネクタ（ラージコネクターミニコネクタ）長さ5cm<br>部品コード:DCK2-004<br>RCカーバッテリーの充電には必ずこちらのケーブルをお使いください。市販のものは、極性が反対な場合がございます。|１本|
|![](./img/BOM/DCK2_RAPISCREW.jpg)|Raspberry Pi取り付けねじ<br><br>スペーサー M2.6*9　AS-2609B（予備１個）・・・・・5個<br>皿ネジ M2.6x5 （予備１個）・・・・・5個<br>ネジ M2.6x5 （予備１個）・・・・・5個|１袋|
...
|![](./img/BOM/DCR2_PIN.jpg)|固定ピン<br>X000YMXW3<br>本体付属の固定ピンもご使用になれます。<br>予備・・・・・2個|１袋|
...
モバイルバッテリーをベースプレートに貼ります。プレートの先端から約25mmぐらいのところにはります。モバイルバッテリーの向きは、USBポートがある方が後ろとなります。
...
|画像|使用するパーツ|個数|
|:--|:--|:--:|
|![](./img/BOM/DCR2_PIN.jpg){: style="height:112px;width:200px;"}|固定ピン|２個|
