...
本SDイメージでは、DonkeyCarをJupyterから起動します。
...
v4.4, v4.5を動作されるには、{{ download_link('https://faboplatform.github.io/DonkeyDocs/7.SDカード作成/myconfig.py', 'myconfig.py') }}をダウンロードして、書き直してください。
